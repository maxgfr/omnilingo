...
export default function Onboarding({ children }: OnboardingProps) {
  ...
  const handleFinish = () => finishOnboarding();
          ...
          {step === 4 && (
            <div className="space-y-5">
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {t("onboarding.aiSetupDescription")}
                </p>
              </div>
              <div className="space-y-3">
                {AI_PROVIDERS.map((provider) => (
                  ...
                  >
                    ...
                    {provider.noKey && (
                      <span className="text-xs text-gray-400">{t("onboarding.noKeyNeeded")}</span>
                    )}
                    {aiProvider === provider.value && (
              ...
              <button
                ...
                disabled={
                  ...
                  (!AI_PROVIDERS.find((p) => p.value === aiProvider)?.noKey && !aiApiKey.trim())
                }
              ...
              >
                {aiTestStatus === "testing" ? (
                  ...
                  <>
                    <Check size={16} className="text-emerald-500" /> Connection OK
                  </>
                ) : aiTestStatus === "error" ? (
                  <span className="text-red-500 text-xs truncate max-w-full">{aiTestError}</span>
                ) : (
                  "Test connection"
                )}
              </button>
              <div className="flex gap-3">
                ...
                <button
                  ...
                  className="flex-1 py-3 bg-gradient-to-r from-purple-500 to-indigo-500 hover:from-purple-600 hover:to-indigo-600 text-white font-semibold rounded-xl transition-all"
                >
                  {t("onboarding.getStarted")}
          ...
          {step === 5 && (
            <div className="space-y-5">
              <div className="text-center space-y-2">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400">
                  {t("onboarding.addContentDescription")}
                </p>
              </div>
              ...
              >
                ...
                <div className="text-left">
                  <p className="font-semibold text-gray-900 dark:text-white text-sm">
                    {t("onboarding.importDict")}
                  </p>
                  <p className="text-xs text-gray-500 dark:text-gray-400">
                    {t("onboarding.importDictDescription")}
                  </p>
                </div>
              </button>
              ...
              <div className="flex gap-3">
                ...
                {downloadDone ? (
                  ...
                  <button
                    onClick={handleSkip}
                    className="flex-1 text-center text-sm text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors py-2.5"
                  >
